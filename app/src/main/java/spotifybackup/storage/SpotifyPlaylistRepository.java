...
class SpotifyPlaylistRepository {
     ...
     */
    static Optional<SpotifyPlaylist> find(EntityManager entityManager, @NonNull String id) {
        if (id.isBlank() || entityManager.find(SpotifyID.class, id) == null) return Optional.empty();
        var query = entityManager.createNamedQuery("SpotifyPlaylist.findBySpotifyID", SpotifyPlaylist.class);
