...
public class SpotifyObjectRepository {
    ...
    /**
     * Attempts to persist a User from the output of the spotify-web-api whilst restricting the amount of images saved.
     * @param apiUser   User object generated by the spotify-web-api.
     * @param selection Restrict which images are persisted.
     * @return SpotifyUser already in the database with matching Spotify ID or new SpotifyUser if apiUser has a new
     * Spotify ID.
     */
    ...
    /**
     * Attempts to persist an Artist from the output of the spotify-web-api whilst restricting the amount of images
     * saved.
     * @param apiArtist Artist object generated by the spotify-web-api.
     * @param selection Restrict which images are persisted.
     * @return SpotifyArtist already in the database with matching Spotify ID or new SpotifyArtist if apiArtist has a
    ...
    /**
     * Attempts to persist an Album from the output of the spotify-web-api whilst restricting the amount of images
     * saved.
     * @param apiAlbum Album object generated by the spotify-web-api.
     * @param selection Restrict which images are persisted.
     * @return SpotifyAlbum already in the database with matching Spotify ID or new SpotifyAlbum if apiAlbum has a new
    ...
    /**
     * Attempts to persist an array of Artist objects from the output of the spotify-web-api whilst restricting the
     * amount of images saved.
     * @param artists   An array of Artist objects generated by the spotify-web-api.
     * @param selection Restrict which images are persisted.
     * @return List of SpotifyArtist objects.
     */
    public List<SpotifyArtist> persist(@NonNull Artist[] artists, @NonNull ImageSelection selection) {
        return persistAbstractModels(artists, new ArrayList<>(),
                (em, artist) -> SpotifyArtistRepository.persist(em, artist, selection));
    }
    ...
    /**
     * Attempts to persist an array of Album objects from the output of the spotify-web-api whilst restricting the
     * amount of images saved.
     * @param apiAlbums An array of Album objects generated by the spotify-web-api.
     * @param selection Restrict which images are persisted.
     * @return List of SpotifyAlbum objects.
    ...
    /**
     * Attempts to persist an array of Album objects from the output of the spotify-web-api, without saving the tracks
     * it contains to save on database size.
     * @param apiAlbums An array of Album objects generated by the spotify-web-api.
     * @return List of SpotifyAlbum objects.
     */
    public List<SpotifyAlbum> persistWithoutTracks(@NonNull Album[] apiAlbums) {
        return persistAbstractModels(apiAlbums, new ArrayList<>(), SpotifyAlbumRepository::persistWithoutTracks);
    }

    /**
     * Attempts to persist an array of Album objects from the output of the spotify-web-api, without saving the tracks
     * it contains to save on database size whilst also restricting the amount of images saved.
     * @param apiAlbums An array of Album objects generated by the spotify-web-api.
     * @param selection Restrict which images are persisted.
     * @return List of SpotifyAlbum objects.
     */
    public List<SpotifyAlbum> persistWithoutTracks(@NonNull Album[] apiAlbums, @NonNull ImageSelection selection) {
        throw new UnsupportedOperationException("to be implemented");
    }
