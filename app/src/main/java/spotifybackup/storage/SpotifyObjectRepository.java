...
//            var playlistItemOptional = SpotifyPlaylistItemRepository.find(em, spotifyID);
//            if (playlistItemOptional.isPresent()) return playlistItemOptional;
     ...
     * @return SpotifyArtist already in the database with matching Spotify ID or new SpotifyArtist if apiArtist has a new Spotify ID.
     */
