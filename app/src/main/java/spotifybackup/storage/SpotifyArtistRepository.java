...
public class SpotifyArtistRepository {
     ...
     */
    public Optional<SpotifyArtist> find(@NonNull se.michaelthelin.spotify.model_objects.specification.Artist apiArtist) {
    ...
    public Optional<SpotifyArtist> find(@NonNull String id) {
        try (var entityManager = emf.createEntityManager()) {
            var query = entityManager.createNamedQuery("Artist.findBySpotifyID", SpotifyArtist.class);
     ...
     */
    public SpotifyArtist persist(@NonNull se.michaelthelin.spotify.model_objects.specification.Artist apiArtist) {
     ...
     */
    public Set<SpotifyArtist> persistAll(@NonNull se.michaelthelin.spotify.model_objects.specification.Artist[] apiArtists) {
